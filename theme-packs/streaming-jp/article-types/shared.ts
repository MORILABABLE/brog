...
export interface TitleRule {
   ...
   *
   * ★ **主題軸の記事にだけ渡すこと。** サービス軸（`【2026年8月】Disney+で…`）に
   *   同じ問いは置けない。「Disney+はどこで見れる？」は文として成立しないし、
   *   月次の一覧は**76本の行き先が並ぶ**ので、作品ページのような行き止まりにならない。
   *   診断がそのまま移らない面に、同じ処方を当てないこと（naming.md に理由を書いてある）。
   *
