...
description: '「名探偵コナン」劇場版シリーズはU-NEXT・Netflix・Disney+での見放題配信を終了しました。32本すべての終了日と、9月6日時点でAmazon Prime Video・Disney+の見放題にある作品を表にまとめています。'
pubDate: 2026-09-06
category: 'ended'
tags: ['U-NEXT', 'Netflix', 'Disney+', '配信終了', 'シリーズ']
sources:
...
---
「名探偵コナン」劇場版シリーズのU-NEXT・Netflix・Disney+での見放題配信は終了しました。記事作成時点（9月6日時点）で32本すべての見放題配信が終了していますが、**同じ時点でAmazon Prime VideoとDisney+でも一部タイトルが見放題で配信されています**。作品ごとの配信状況は下の表で確認できます！
...
> 配信状況・見放題終了日は U-NEXT の作品ページに掲載されている情報にもとづきます（9月6日時点）。終了日は変更される場合があります。
