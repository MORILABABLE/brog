---
title: '【保存版】「トランスフォーマー」実写映画シリーズの見放題配信中の作品5本【9月6日更新】｜マイケル・ベイの5作'
...
---
「トランスフォーマー」実写映画シリーズは、記事作成時点（9月6日時点）で5本がAmazon Prime Videoの見放題で配信中です。それぞれの見放題での取り扱いがいつまで続くかは公表されておらず、当サイトでも終了日を把握できていません。この記事は各サービスの配信状況を随時更新しています。他のサービスでの取り扱いは、各作品の検索リンクから確かめてください。
...
| — | トランスフォーマー/リベンジ | 見放題配信中 | 60/100 | Amazon Prime Video |
| — | トランスフォーマー/ダークサイド・ムーン | 見放題配信中 | 62/100 | Amazon Prime Video |
| — | トランスフォーマー/ロストエイジ | 見放題配信中 | 57/100 | Amazon Prime Video |
| — | トランスフォーマー/最後の騎士王 | 見放題配信中 | 54/100 | Amazon Prime Video |

**第1作から第5作までが、まとめて見放題の対象になっています。** 実写シリーズを頭から通して観られる状態です。5本とも一度は見放題の終了日が予告されていましたが、その日を過ぎたあとも見放題での配信が続いています。
