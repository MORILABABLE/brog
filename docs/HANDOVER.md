...
- セクション画像を記事に**初めて**挿し込む `npm run sections -- --write` は手動実行
  ...
  （`.github/workflows/images.yml` が毎日 05:30 JST。2026-09-05〜）
